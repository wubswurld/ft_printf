...
CFILES = ft_printf.c ft_extra.c ex.c basic.c mostbasic.c bool.c width.c morefunctions.c octal.c check.c point.c binary.c prec.c init.c uilltoa.c handle_int.c
